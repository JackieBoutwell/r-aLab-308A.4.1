...
var API_KEY = "live_92QsgmenerVyDjykZgwa3ZwyxNY2J9XZISpKsLEUvpGndNeM1osQ1D7i4Bbl8C9N";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          console.log("Fetching got error:", _context.t0);
        case 10:
        case "end":
...
function breedSelectHandler(_x) {
  return _breedSelectHandler.apply(this, arguments);
}
/**
 ...
 */
function _breedSelectHandler() {
  _breedSelectHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var breedId, responseBreed, breedInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          Carousel.clear();
          //console.log("working");
          breedId = event.target.value; // console.log(breedId, "breed id");
          _context2.next = 4;
          return _axios.default.get("https://api.thecatapi.com/v1/images/search?breed_ids=".concat(breedId, "&limit=8"), {
            onDownloadProgress: updateProgress
          });
        case 4:
          ...
          responseBreed.data.forEach(function (breed) {
            console.log(breed);
            // const imgTag = document.createElement("img");
            // imgTag.setAttribute("src", breed.url)
            var item = Carousel.createCarouselItem(breed.url, "", breed.id);
            Carousel.appendCarousel(item);
            Carousel.start();
          });
          _context2.next = 8;
        ...
        case 8:
          ...
          infoDump.innerHTML = "";
          info.innerHTML = "<h2>".concat(breedInfo.data.name, "</h2>\n   <p>").concat(breedInfo.data.description, "</p>");
          infoDump.appendChild(info);
          //console.log(info);
        case 12:
        case "end":
...
function _deleteFavorite() {
  _deleteFavorite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(imgId) {
    var favorites, favToDelete;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _axios.default.get('https://api.thecatapi.com/v1/favourites?limit=20&sub_id=my-favs&order=DESC', {
            headers: {
              "content-type": "application/json",
              'x-api-key': API_KEY
            }
        ...
        case 2:
          ...
          favToDelete = favorites.data.filter(function (fav) {
            if (fav.image_id === imgId) {
              return fav;
            }
          });
          _context4.next = 6;
          return _axios.default.delete("https://api.thecatapi.com/v1/favourites/".concat(favToDelete[0].id), {
            headers: {
              'x-api-key': API_KEY
            }
          }).then(function (response) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          info.innerHTML = "";
          _context5.next = 4;
          return _axios.default.get('https://api.thecatapi.com/v1/favourites?order=DESC&sub_id=my-favs', {
            headers: {
              'content-type': 'application/json',
              'x-api-key': API_KEY
            }
        ...
        case 4:
          getFavs = _context5.sent;
          getFavs.data.forEach(function (breed) {
            var item = Carousel.createCarouselItem(breed.image.url, "", breed.image.id);
            Carousel.appendCarousel(item);
            Carousel.start();
          });
        case 6:
